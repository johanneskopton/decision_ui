...
const saveZip = () => {
  ...
  zip.file(
    "estimates.csv",
    modelStore.decisionSupportResult.estimates
  );
...
<template>
  <Dashboard>
    ...
    <v-sheet class="floating_btn_group float-left" color="white" elevation="4" rounded
      v-if="modelStore.decisionSupportResult !== null" @click="saveZip">
